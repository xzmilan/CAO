...
- **Next step:** Metric layer is the best candidate for the same incremental treatment (it joins 1:1 to the raw entity's ID, so it can scope to the same changed-policy set). This is a documented phase-2 opportunity, not something to rush.
